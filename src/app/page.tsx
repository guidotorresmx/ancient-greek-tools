...
export default function Home() {
  ...
  const TOOLS = [
    {
      title: tPages("letras.title"),
      description: tPages("letras.desc"),
      icon: <Sparkles className="w-6 h-6" />,
      href: "/letras",
      color: "bg-amber-500/10 text-amber-500",
    },
    {
      title: tPages("memory.title"),
      description: tPages("memory.desc"),
      icon: <Brain className="w-6 h-6" />,
      href: "/memory",
      color: "bg-blue-500/10 text-blue-500",
    },
    {
      title: tPages("vocabulario.title"),
      description: tPages("vocabulario.desc"),
      icon: <Brain className="w-6 h-6" />,
      href: "/vocabulario",
      color: "bg-emerald-500/10 text-emerald-500",
    },
    {
      title: tPages("lectura.title"),
      description: tPages("lectura.desc"),
    ...
    <div className="flex flex-col items-center pt-20 pb-32">
      ...
      <section className="w-full max-w-4xl text-center space-y-8 mb-24 px-4">
        ...
        <h1 className="text-5xl md:text-7xl font-bold tracking-tight animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
          {tCommon("ui.master_language")} <br />
          <span className="text-gradient">
            {tCommon("ui.philosophers_poets")}
          </span>
        </h1>
